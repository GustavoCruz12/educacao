...
class Noticia(models.Model):
    ...
    resumo = models.CharField(verbose_name='resumo', blank=True, max_length=250)
    ...
    imagem = FileBrowseField(verbose_name='image de destaque', max_length=120, directory="noticias/", blank=True, null=True)
